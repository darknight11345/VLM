...
#SBATCH --output=/pfs/work9/workspace/scratch/ul_swv79-pixtral/Pixtral-Finetune/inference_scripts/slurm_log/pixtral_gpu.%j.out


#MODEL_NAME="mistral-community/pixtral-12b"
#export WS_MODEL=$(ws_find pixtral) for testing
export WS_MODEL="/pfs/work9/workspace/scratch/ul_swv79-pixtral"
export RESULTS_DIR="$WS_MODEL/Pixtral-Finetune/output/inference_results"
...
## 4) Inferenz ---------------------------------------------------------
python "$WS_MODEL/Pixtral-Finetune/inference_scripts/all_experiments_mistral.py" \
