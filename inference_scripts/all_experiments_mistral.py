...
if __name__ == "__main__":
    ...
    model_dir = "/pfs/work9/workspace/scratch/ul_swv79-pixtral/pixtral-12b/"
    ...
    llm = LLM(
        ...
        tokenizer=model_dir, #"/pfs/work9/workspace/scratch/ul_swv79-pixtral/pixtral-12b/tokenizer.json",  #tokenizer_mode="mistral",
    ...
    RESULTS_ROOT = "/pfs/work9/workspace/scratch/ul_swv79-pixtral/Pixtral-Finetune/output/inference_results/"  # path for results directory
